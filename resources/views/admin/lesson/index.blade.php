	...
	<table class="table table-border table-bordered table-bg">
		<thead>
			...
			<tr class="text-c">
				...
				<th width="40">ID</th>
				<th width="150">视频课程名</th>
				<th width="90">所属课程</th>
				<th width="50">排序</th>
				<th width="60">视频时长(s)</th>
				<th width="70">播放</th>
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>
				<a href="javascript:;" onclick="video_play('{{$val->lesson_name}}','{{URL::asset('admin/lesson/play')}}','{{$val->id}}','800','500')" class="btn btn-primary radius">
				<i class="Hui-iconfont">&#xe6e6;</i> 播放</a>
				</td>
				...
				<td class="td-manage">
                    ...
                    @else
                    <a style="text-decoration:none" onClick="admin_start(this,'10001')"
...
*/
/*点播-增加*/
function video_play(title,url,id,w,h){
