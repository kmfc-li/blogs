...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			...
			<a href="javascript:;" onclick="member_add('添加试题','{{url::asset('')}}','','510')" class="btn btn-primary radius">
			<i class="Hui-iconfont">&#xe600;</i> 添加试题</a>


			<a href="javascript:;" onclick="location.href='{{url::asset('admin/question/export')}}'" class="btn btn-primary radius">
			<i class="Hui-iconfont">&#xe644;</i> 导出试题</a>
			<a href="javascript:;" onclick="_import('导入试题','{{url::asset('admin/question/import')}}','','510')" class="btn btn-primary radius">
			<i class="Hui-iconfont">&#xe645;</i> 导入试题</a>
		</span> 
