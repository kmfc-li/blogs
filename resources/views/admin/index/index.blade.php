...
<link rel="stylesheet" type="text/css" href="{{URL::asset('admin/static/h-ui.admin/skin/red/skin.css')}}" id="skin" />
			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						...
						<li><a href="#">切换账户</a></li>
						<li><a href="{{URL::asset('admin/public/logout')}}">退出</a></li>
				</ul>
			</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="{{URL::asset('admin/protype/index')}}" data-title="专业分类" href="javascript:void(0)">专业分类</a></li>
					<li><a data-href="{{URL::asset('admin/profession/index')}}" data-title="专业列表" href="javascript:void(0)">专业列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="{{URL::asset('admin/course/index')}}" data-title="课程列表" href="javascript:void(0)">课程列表</a></li>
					<li><a data-href="{{URL::asset('admin/lesson/index')}}" data-title="点播列表" href="javascript:void(0)">点播列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="{{URL::asset('admin/paper/index')}}" data-title="试卷管理" href="javascript:void(0)">试卷管理</a></li>
					<li><a data-href="{{URL::asset('admin/question/index')}}" data-title="试题管理" href="javascript:void(0)">试题管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a data-href="{{URL::asset('admin/stream/index')}}" data-title="直播流列表" href="javascript:;">直播流列表</a></li>
					<li><a data-href="{{URL::asset('admin/live/index')}}" data-title="直播课程" href="javascript:void(0)">直播课程</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="{{URL::asset('admin/member/index')}}" data-title="会员列表" href="javascript:;">会员列表</a></li>
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="{{URL::asset('admin/role/index')}}" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
					<li><a data-href="{{URL::asset('admin/auth/index')}}" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
					<li><a data-href="{{URL::asset('admin/manager/index')}}" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-tongji">
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="{{URL::asset('admin/index/welcome')}}">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe id="iframe-welcome" data-scrolltop="0" scrolling="yes" frameborder="0" src="{{URL::asset('admin/index/welcome')}}"></iframe>
	</div>
</div>
</section>
...
<script type="text/javascript" src="{{URL::asset('admin/static/h-ui.admin/js/H-ui.admin.js')}}"></script>
<!--/_footer 作为公共模版分离出去-->
