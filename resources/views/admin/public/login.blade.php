...
<link href="{{URL::asset('admin/static/h-ui.admin/css/H-ui.login.css')}}" rel="stylesheet" type="text/css" />
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="{{URL::asset('admin/public/check')}}" method="post">
      <div class="row cl">
